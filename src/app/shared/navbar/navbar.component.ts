...
export class NavbarComponent implements OnInit {
    ...
    constructor(location: Location, private renderer: Renderer2, private element: ElementRef, private router: Router,private baseService: BaseService,  public authService: AuthService) {
